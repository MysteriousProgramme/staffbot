...
console.log('  Read Message History, Manage Messages, Manage Channels (tickets),');
console.log('  Manage Roles, View Audit Log — plus the applications.commands scope');
console.log('  that slash commands require.\n');
